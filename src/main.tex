...
\include{chapters/ch01} % Cap. 1 — A arte de combinar informações
\include{chapters/ch02} % Cap. 2 — Interpolação: o ponto de partida
\include{chapters/ch03} % Cap. 3 — Ajuste por mínimos quadrados
\include{chapters/ch04} % Cap. 4 — Ajustes em 2D e suavização
\include{chapters/ch05} % Cap. 5 — Análise objetiva (Cressman, Barnes)
...
\include{chapters/ch06} % Cap. 6 — Formulação estatística (B, R, K)
\include{chapters/ch07} % Cap. 7 — Filtro de Kalman, EKF, EnKF
\include{chapters/ch08} % Cap. 8 — 3DVar e 4DVar
\include{chapters/ch09} % Cap. 9 — Métodos híbridos (3D/4DEnVar)
\include{chapters/ch10} % Cap. 10 — Sistemas operacionais: GSI, JEDI, LETKF
\include{chapters/ch11} % Cap. 11 — Futuro da AD: IA, acoplado, trópicos, sensores
